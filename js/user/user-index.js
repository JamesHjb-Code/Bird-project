  ...
  function getData2(page){
    $.ajax({
      ...
      success: function (data) {
        //通过json传递过来
        var count = data[0].count;//数据总条数据
        var text1 = "<div class='font-box'><div class='fontSum'><span>"+count+"</span></div> <div class='fontSt'><span>鸟目分类</span></div></div><div class='icon-box'><i class='fa fa-pie-chart'></i></div>";
