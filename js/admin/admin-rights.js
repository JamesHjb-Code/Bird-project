...
window.onload=function(){
  ...
  function getData(page,totalPage){
    $.ajax({
      type: 'POST',
      url: '../../php/admin/admin-pageRights.php',
      data: {'page':page},
      dataType:'json',
      success:function(data){
        ...
        var str="";
        for(var i=0;i<num;i++){
          str+="<tr><td style='width:54px;'>" + data[i].id +"</td><td style='width:102px;'>" + data[i].username +"</td><td style='width:104px;'>" + data[i].bird_music + "</td><td style='width:104px;'>" + data[i].bird_add +"</td><td style='width:104px;'>"+data[i].bird_Query+"</td><td style='width:100px;'>"+"<button class='btn btn-primary btn-xs' id='change' data-toggle='modal' data-target='myModal'>修改</button>"+"</td></tr>";
        }
...
$(document).on("click","#sign",function(){
  ...
  $.ajax({
    url:"../../php/admin/admin-changeRights.php?id="+t,
    type:"POST",
    data:data1,
